...
class qtype_multianswergreek_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        if ($questiontext = optional_param_array('questiontext', false, PARAM_RAW)) {
            $this->questiondisplay = fullclone(qtype_multianswergreek_extract_question($questiontext));
        ...
        if (isset($question->id) and $question->id and $question->qtype &&
            ...
            foreach ($question->options->questions as $key => $wrapped) {
                if (!empty($wrapped)) {
                    ...
                    // update all multianswergreek questions.
    ...
    public function validation($data, $files) {
        ...
        $questiondisplay = qtype_multianswergreek_extract_question($data['questiontext']);
