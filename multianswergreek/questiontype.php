    ...
    public function save_question_options($question) {
        ...
        if (!empty($sequence)) {
            ...
            if ($oldid = $DB->get_field('question_multianswergreek', 'id',
                ...
                $DB->insert_record('question_multianswergreek', $multianswergreek);
            }
        }
...
function qtype_multianswergreek_extract_question($text) {
    ...
    $question->qtype = 'multianswergreek';
 ...
 *
 * @param object $question  The multianswergreek question to validate as returned by qtype_multianswergreek_extract_question
