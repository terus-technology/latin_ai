 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswergreek_attempt_upgrader_test extends question_attempt_upgrader_test_base {
    public function test_multianswergreek_adaptivenopenalty_qsession104() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
            'intro' => '',
            'introformat' => '1',
            'timeopen' => '0',
            'timeclose' => '0',
    ...
    public function test_multianswergreek_adaptivenopenalty_qsession106() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
    ...
    public function test_multianswergreek_adaptivenopenalty_qsession108() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
    ...
    public function test_multianswergreek_adaptivenopenalty_qsession105() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
...
b) What grade would you give it? _____',
    ...
    public function test_multianswergreek_adaptivenopenalty_qsession107() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
...
b) What grade would you give it? _____',
    ...
    public function test_multianswergreek_adaptivenopenalty_qsession109() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'multianswergreek quiz',
