...
/**
 * Unit tests for qtype_multianswergreek_question.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswergreek_question_test extends advanced_testcase {
    public function test_get_expected_data() {
        $question = test_question_maker::make_question('multianswergreek');
    ...
    public function test_summarise_response() {
        ...
        $this->assertEquals(get_string('subqresponse', 'qtype_multianswergreek',
                array('i' => 1, 'response' => 'Owl')) . '; ' .
                get_string('subqresponse', 'qtype_multianswergreek',
    ...
    public function test_get_num_parts_right_fourmc() {
        // Create a multianswergreek question with four mcq.
        $question = test_question_maker::make_question('multianswergreek', 'fourmc');
        $question->start_attempt(new question_attempt_step(), 1);
