 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswergreek_test extends advanced_testcase {
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'multianswergreek');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('multianswergreek', 'twosubq');
    ...
    public function test_question_saving_twosubq() {
        ...
        $questiondata = test_question_maker::get_question_data('multianswergreek');
        $formdata = test_question_maker::get_question_form_data('multianswergreek');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_multianswergreek_edit_form::mock_submit((array)$formdata);

        $form = qtype_multianswergreek_test_helper::get_question_editing_form($cat, $questiondata);
    ...
    public function test_questiontext_extraction_of_multiplechoice_subquestions_variants() {
        ...
        $q = qtype_multianswergreek_extract_question($questiontext);
