 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswergreek_walkthrough_test extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback() {
        ...
        // Create a multianswergreek question.
        $q = test_question_maker::make_question('multianswergreek', 'fourmc');
    ...
    public function test_deferred_feedback_numericalzero_not_answered() {
        ...
        // Create a multianswergreek question with one numerical subquestion, right answer zero.
        $q = test_question_maker::make_question('multianswergreek', 'numericalzero');
    ...
    public function test_deferred_feedback_multiple() {
        ...
        // Create a multianswergreek question.
        $q = test_question_maker::make_question('multianswergreek', 'multiple');
