@qtype @qtype_multianswergreek
Feature: Test creating a multianswergreek (Cloze) question
  As a teacher
  ...
  Scenario: Create a broken Cloze question and correct it
    ...
    And I press "Add"
    And I set the field "Question name" to "multianswergreek-002"
    ...
    And I should see "multianswergreek-002" in the "categoryquestions" "table"
  ...
  Scenario: Try to create a Cloze question that has no answer
    ...
    And I press "Add"
    And I set the following fields to these values:
      | Question name | multianswergreek-003                                |
