...
$string['invalidmultianswergreekquestion'] = 'Invalid embedded answers (Cloze) question ({$a}).';
...
$string['pluginnameediting'] = 'Editing an Embedded answers (Greek) question';
...
$string['privacy:metadata'] = 'The Embedded answers (Greek) question type plugin does not store any personal data.';
...
$string['questionsmore'] = '{$a} question(s) more than in the multianswergreek question stored in the database';
