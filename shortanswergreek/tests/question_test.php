...
class qtype_shortanswergreek_question_test extends advanced_testcase {
    public function test_compare_string_with_wildcard() {
        ...
        $this->assertTrue((bool)qtype_shortanswergreek_question::compare_string_with_wildcard(
                'Frog', 'Frog', false));
        $this->assertFalse((bool)qtype_shortanswergreek_question::compare_string_with_wildcard(
                'Frog', 'frog', false));
        $this->assertTrue((bool)qtype_shortanswergreek_question::compare_string_with_wildcard(
                '   Frog   ', 'Frog', false));
        $this->assertFalse((bool)qtype_shortanswergreek_question::compare_string_with_wildcard(
