 ...
 */
class qtype_shortanswergreek_test_helper extends question_test_helper {
    /**
     * Get test questions
     *
     * @return array
    ...
    public function get_test_questions() {
        return ['frogtoad', 'frogonly', 'escapedwildcards'];
    }
    ...
    public function get_shortanswer_question_form_data_frogtoad() {
        ...
        $form->questiontext = ['text' => 'Name an amphibian: __________', 'format' => FORMAT_HTML];
        $form->defaultmark = 1.0;
        $form->generalfeedback = ['text' => 'Generalfeedback: frog or toad would have been OK.', 'format' => FORMAT_HTML];
        $form->usecase = false;
        $form->answer = ['frog', 'toad', '*'];
        $form->fraction = ['1.0', '0.8', '0.0'];
        $form->feedback = [
            ['text' => 'Frog is a very good answer.', 'format' => FORMAT_HTML],
            ['text' => 'Toad is an OK good answer.', 'format' => FORMAT_HTML],
